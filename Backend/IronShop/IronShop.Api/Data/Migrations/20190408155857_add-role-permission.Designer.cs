...
namespace IronShop.Api.Migrations
{
    ...
    [Migration("20190408155857_add-role-permission")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IronShop.Api.Core.Entities.Permission", b =>
                {
                    ...
                    b.Property<int?>("ParentPermissionId1");
                    ...
                    b.HasIndex("ParentPermissionId1");
            ...
            modelBuilder.Entity("IronShop.Api.Core.Entities.RolePermission", b =>
                {
                    b.Property<int>("RoleId");
            ...
            modelBuilder.Entity("IronShop.Api.Core.Entities.Permission", b =>
                {
                    b.HasOne("IronShop.Api.Core.Entities.Permission", "Parent")
                        .WithMany("SubPermissions")
                        .HasForeignKey("ParentPermissionId1");
                });

            modelBuilder.Entity("IronShop.Api.Core.Entities.RolePermission", b =>
                {
                    b.HasOne("IronShop.Api.Core.Entities.Permission", "Permission")
